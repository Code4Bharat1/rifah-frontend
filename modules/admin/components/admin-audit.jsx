...
import { auditLogs } from "@shared/lib/mock-data";

function AdminAudit() {
  return (
    <AppShell role="admin" title="Audit log" subtitle="Every administrative action is recorded">
              ...
              <li key={a.id} className="grid grid-cols-[auto_minmax(0,1fr)] gap-3 p-4">
                ...
                <div className="min-w-0">
                  <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3">
                    ...
                    <Pill tone="primary">{a.actor}</Pill>
                  </div>
                  <p className="mt-0.5 truncate text-sm text-muted-foreground">{a.target}</p>
